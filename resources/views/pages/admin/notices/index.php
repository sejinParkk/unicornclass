	...
	<table class="data-table">
		...
		<?php else: ?>
			...
			<tr>
				...
				<td style="max-width:360px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-weight:<?= $n['is_pinned'] ? '600' : '400' ?>;">
					<?= htmlspecialchars($n['title']) ?>
				</td>
				<td><?= $n['is_pinned'] ? '<span class="badge badge-pinned">고정</span>' : '' ?></td>
				<td>
